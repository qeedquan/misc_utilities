...
VIP_BUILD_OPTIONS=""
VIP_COMPONENTS="INCLUDE_ROMFS INCLUDE_STANDALONE_DTB INCLUDE_PATCH_STANDALONE_DTB INCLUDE_STANDALONE_SYM_TBL INCLUDE_FDT_SHOW INCLUDE_LOOPFS"
VIP_BUNDLES=""
...
build_vip() {
	vxprj create -force $SMP $BSP $VIP -profile $PROFILE -vsb $VSB
	pushd $VIP
	copy_romfs
