...
VSB_COMPONENTS=""
VSB_CONFIGURATION="_WRS_CONFIG_DEBUG_FLAG=y _WRS_CONFIG_COMPONENT_IPSSH=y" # _WRS_CONFIG_IPCOM_DEBUG_ADVANCED=y"
VSB_BUILD_OPTIONS=""
...
VIP_COMPONENTS="INCLUDE_RAM_DISK INCLUDE_IPCOM_USE_RAM_DISK INCLUDE_ROMFS \
	...
	INCLUDE_ISR_SHOW INCLUDE_VXBUS_SHOW INCLUDE_MEM_EDR_SHOW INCLUDE_TIMER_SYS_SHOW INCLUDE_PCI_BUS_SHOW INCLUDE_USB_SHOW"
...
build_vip() {
	vxprj vip create -force $SMP -profile $PROFILE -vsb $VSB $BSP $COMPILER $VIP
	pushd $VIP
	copy_romfs
