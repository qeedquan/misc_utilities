...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frequency = frequency = 106.1e6

        ##################################################
        # Blocks
        ##################################################
        self._volume_range = Range(0, 1, 0.05, 1, 200)
        self._volume_win = RangeWidget(self._volume_range, self.set_volume, 'volume', "counter_slider", float)
        self.top_grid_layout.addWidget(self._volume_win)
        self._frequency_range = Range(85e6, 120e6, 1e5, 106.1e6, 200)
    ...
    def set_frequency(self, frequency):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.frequency, 20e6)
